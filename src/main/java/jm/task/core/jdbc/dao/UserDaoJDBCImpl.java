...
public class UserDaoJDBCImpl implements UserDao {
    ...
    public void saveUser(String name, String lastName, byte age) {
        try (Connection conn = util.getConnection(); PreparedStatement pst = conn.prepareStatement(insertData)) {
    ...
    public List<User> getAllUsers() {
        ...
        try (Connection conn = util.getConnection(); PreparedStatement prst = conn.prepareStatement(selectUser); ResultSet rst = prst.executeQuery()) {
            while (rst.next()) {
